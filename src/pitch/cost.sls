...
(library (pitch cost)
  (export
    make-cost-factory cost-factory?
    cost-factory-cost<=? cost-factory-cost+
    cost-factory-cost-text cost-factory-cost-nl
    cost-factory-limit
    default-cost-factory default-computation-width)
  (import
    (rnrs base (6))
    (rnrs control (6))
...
;; what `div` computes.
(define (default-computation-width page-width)
  (div (* page-width 6) 5))
...
(define (default-cost<=? c1 c2)
  (let ((b1 (car c1)) (h1 (cadr c1))
        (b2 (car c2)) (h2 (cadr c2)))

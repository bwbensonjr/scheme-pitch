...
;; terminate on circular arguments. Opaque numeric vectors compare by their
;; shared private marker and retained lexeme, while remaining unequal to every
;; ordinary datum source can construct.

...
;; carried by its token. Comparing two projections is still equal?, which R6RS
;; requires to terminate on circular arguments; the opaque value's private
;; singleton marker makes it unequal to every source-constructible vector.
;;

...
(library (pitch doc)
  (export
    ...
    us-concat v-append v-concat a-append a-concat as-append as-concat space lparen
    ...
    doc-reset? doc-reset-d doc-full? doc-full-d doc-cost? doc-cost-n doc-cost-d
    doc-fail?)
  (import
    (rnrs base (6))
    (rnrs control (6))

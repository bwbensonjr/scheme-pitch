...
;; Benchmark corpus member: hand-written code, 11 copies of the unit.
;;
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-1) (bench sequence-1))
(begin
...
;; ---- src/pitch/table.sld, copy 1 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-1)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-2) (bench sequence-2))
(begin
...
;; ---- src/pitch/table.sld, copy 2 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-2)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-3) (bench sequence-3))
(begin
...
;; ---- src/pitch/table.sld, copy 3 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-3)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-4) (bench sequence-4))
(begin
...
;; ---- src/pitch/table.sld, copy 4 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-4)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-5) (bench sequence-5))
(begin
...
;; ---- src/pitch/table.sld, copy 5 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-5)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-6) (bench sequence-6))
(begin
...
;; ---- src/pitch/table.sld, copy 6 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-6)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-7) (bench sequence-7))
(begin
...
;; ---- src/pitch/table.sld, copy 7 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-7)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-8) (bench sequence-8))
(begin
...
;; ---- src/pitch/table.sld, copy 8 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-8)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-9) (bench sequence-9))
(begin
...
;; ---- src/pitch/table.sld, copy 9 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-9)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)
...
(export
  ...
  ;; serialization
  cst-leaves cst-tokens cst->text write-cst)
(import (scheme base) (bench reader-10) (bench sequence-10))
(begin
...
;; ---- src/pitch/table.sld, copy 10 ----

;;; Tables with the three equality contracts Pitch needs.
(define-library (bench table-10)
(export
  make-symbol-table make-integer-table make-identity-table table? table-ref table-set!
  table-update! table-delete! table-contains? table-size table-keys table-entries
  table-copy)

...
diagnostics, and a page width, and running tokenizing, parsing, translation,
layout, and the output checks.
...
The page width SHALL default to 88. The operation SHALL perform no file input or
output: it takes a text and returns a text.
